#This file is going to include method that wil parse the specific data that we need from each one of the deal boxes
class BookingReport:
		def __init__(self, boxes_section_element):
				#This is the hotel_boxes element from booking.py
